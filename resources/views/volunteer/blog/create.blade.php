                ...
                <div id="test-nl-1" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper2trigger1">
                    <div class="row g-3">
                        <div class="col-12 col-lg-6">
                            ...
                            <input type="text" id="" class="form-control shadow" value="{{ old('title')}}" name="title">
                        </div>
                        <div class="col-12 col-lg-6">
                        ...
                        <div class="col-12 col-lg-6">
                            ...
                            <input type="file" id="blog_image" class="form-control shadow-lg" name="blog_image"  value="{{ old('blog_image')}}">
                        </div>
                        <div class="col-12 col-lg-6">
