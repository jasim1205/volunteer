...
@section('title',trans('Add New Blog'))
@section('page',trans('Add New Blog'))
@section('content')
                ...
                <div id="test-nl-1" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper2trigger1">
                    <div class="row g-3">
                        <div class="col-12 col-lg-6">
                            ...
                            <input type="text" id="" class="form-control" value="{{ old('title')}}" name="title">
                        </div>
                        <div class="col-12 col-lg-6">
                            <label class=" col-form-label"><strong>Blog Details</strong></label>
                            <input type="text" id="blog_details" class="form-control" value="{{ old('blog_details')}}" name="blog_details" >
                        </div>
                        <div class="col-12 col-lg-6">
